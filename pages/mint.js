...
export default function mint() {
  ...
  return (
    <div className="min-h-screen h-full overflow-hidden flex flex-col items-center justify-center bg-brand-background">
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          <div className="relative z-1 md:max-w-3xl w-full bg-gray-900/90 filter backdrop-blur-sm py-4 rounded-md px-2 md:px-10 flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                <div className="font-coiny flex items-center justify-between w-full">
                  <button
                    className="w-14 h-10 md:w-16 flex md:h-12 items-center justify-center text-brand-background hover:shadow-lg bg-gray-300 font-bold rounded-md"
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              ...
              <a
                href={`https://rinkeby.etherscan.io/address/${config.contractAddressCronos}#readContract`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 mt-4"
              >
                <span className="break-all ...">
                  {config.contractAddressCronos}
                </span>
              </a>
            </div>
          </div>
