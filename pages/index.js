...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden">
      ...
      <header className="min-w-full text-gray-800 py-14 px-4 md:px-6">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          <Link href="#">
            <a
              className="font-coiny text-xl md:text-3xl font-bold"
      ...
      <div className="h-full w-full container max-w-5xl mx-auto flex flex-col item-center pt-4">
        <div className="flex flex-col items-center max-w-4xl w-full">
          <Link href="/mint" passhref>
            <a className="mt-16 font-coiny uppercase inline-flex items-center px-6 py-2 text-sm md:text-2xl font-medium text-center rounded text-rose-500 hover:bg-rose-600 hover:text-white">
              Go to minting page
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full px-6">
            {/* BoredApe Image */}
            <img
              src="/images/1.png"
