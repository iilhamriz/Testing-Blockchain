...
const web3 = createAlchemyWeb3(process.env.NEXT_PUBLIC_ALCHEMY_RPC_URL_RINKEBY);
import { config } from "../dapp.config";

const contract = require("../artifacts/contracts/BoredApe.sol/BoredApe.json");
const nftContract = new web3.eth.Contract(contract.abi, config.contractAddressCronos);
...
export const presaleMint = async (mintAmount) => {
  ...
  const tx = {
    to: config.contractAddressCronos,
